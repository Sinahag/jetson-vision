...
mtx1, dist1, mtx2, dist2, R, T, _, _ = [stereo_data[i] for i in ('mtx1', 'dist1', 'mtx2', 'dist2', 'R', 'T', 'E', 'F')]
...
while True:
    ...
    # Rectify the images
    map1x, map1y = cv2.initUndistortRectifyMap(mtx1, dist1, R, mtx1, frame1.shape[::-1], cv2.CV_32FC1)
    map2x, map2y = cv2.initUndistortRectifyMap(mtx2, dist2, R, mtx2, frame2.shape[::-1], cv2.CV_32FC1)
